...
VALUES (UUID_TO_BIN('68d4435a-3bc0-4bc5-924e-04fab2d2696e'), 'kakao_1001', 'kakao', '김시용',
        'https://picsum.photos/id/1/200',
        '1 year', '프론트엔드 주니어', NOW(), NOW()),
       (UUID_TO_BIN('f42fda6d-7e52-4080-aa52-0d0b822da649'), 'kakao_1002', 'kakao', '서주원',
        'https://picsum.photos/id/2/200',
        '3 years', '백엔드 개발자', NOW(), NOW()),
       (UUID_TO_BIN('1f54ebe7-13ca-4d8a-8241-0a2da18a8c42'), 'kakao_1003', 'kakao', '송창욱',
        'https://picsum.photos/id/3/200',
        '2 years', 'IOS 앱 개발자', NOW(), NOW()),
       (UUID_TO_BIN('878983b7-caeb-490f-8c3c-ba8d6a98a49c'), 'kakao_1004', 'kakao', '은나현',
        'https://picsum.photos/id/4/200',
        '4 years', '기획 전문가', NOW(), NOW()),
       (UUID_TO_BIN('4fde00e9-ff45-4450-9202-a3ab4ec47d6a'), 'kakao_1005', 'kakao', '장정명',
        'https://picsum.photos/id/5/200',
        '5 years', 'DevOps 엔지니어', NOW(), NOW()),
       (UUID_TO_BIN('f6fb4f2a-7365-42e5-98f0-f900553f6199'), 'kakao_1006', 'kakao', '유지민',
        'https://picsum.photos/id/6/200',
        '1 year', '마케팅 주니어', NOW(), NOW()),
       (UUID_TO_BIN('04073ffb-c154-404c-80fd-3ce43e1f574c'), 'kakao_1007', 'kakao', '김민정',
        'https://picsum.photos/id/7/200',
        '6 years', 'PM / 기획 겸직', NOW(), NOW()),
       (UUID_TO_BIN('b86b96bd-d0d8-4de1-b6d7-e5077817fc90'), 'kakao_1008', 'kakao', '장원영',
        'https://picsum.photos/id/8/200',
        '3 years', 'React Native 개발자', NOW(), NOW()),
       (UUID_TO_BIN('9957bfbf-baa2-42ba-8071-e2e59b7fc173'), 'kakao_1009', 'kakao', '이지은',
        'https://picsum.photos/id/9/200',
        '2 years', 'Unity 기반 게임 개발자', NOW(), NOW()),
       (UUID_TO_BIN('ef0a7967-47f8-4438-a111-550a6e75124f'), 'kakao_1010', 'kakao', '고윤정',
